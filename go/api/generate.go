...
//go:generate go tool oapi-codegen -old-config-style -generate types,skip-prune       	-import-mapping engine.yaml:github.com/ForestHubAI/edge-agents/go/api/engineapi,workflow.yaml:github.com/ForestHubAI/edge-agents/go/api/workflow 	-o deployapi/types.gen.go  -package deployapi ../../contract/deployment.yaml
