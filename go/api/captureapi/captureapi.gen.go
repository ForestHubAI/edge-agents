...
// Package captureapi provides primitives to interact with the openapi HTTP API.
//
...
// CaptureMetadata The set of configured capture devices.
type CaptureMetadata struct {
	// Devices Every configured capture device.
	Devices []DeviceMetadata `json:"devices"`
}

// DeviceMetadata Descriptive metadata for one configured capture device.
type DeviceMetadata struct {
	// Description Optional human-readable device description.
	Description string `json:"description,omitempty"`

	// Name Name (id) of the device — the /capture name selector.
...
type ServerInterface interface {
	...
	// List the configured capture devices.
	// (GET /metadata)
