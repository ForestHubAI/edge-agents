...
export const EDGE_DEFINITIONS: Record<EdgeType, EdgeDefinition> = {
  agentTask: {
    ...
    parameters: [{ id: "prompt", label: "Prompt", description: "", type: "expression", expressionType: "string" }],
  },
  agentChoice: {
    label: "Choice",
  ...
  agentDelegate: {
    ...
    parameters: [
      { id: "description", label: "Description", description: "", type: "string", default: "When should the agent take this path?" },
      { id: "prompt", label: "Prompt", description: "", type: "expression", expressionType: "string" },
    ],
  },
  control: {
    label: "Control",
