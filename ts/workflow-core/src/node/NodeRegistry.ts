import { ReadPinNodeDefinition, SerialReadNodeDefinition, RetrieverNodeDefinition, WebFetchNodeDefinition, MicrophoneCaptureNodeDefinition } from "./InputNode";
...
class NodeDefinitionRegistry {
  ...
  initialize() {
    ...
    this.register(MicrophoneCaptureNodeDefinition);
    // Register MQTT nodes
