# Visual Builder - Detailed Architecture

> This document is the detailed reference for the visual-builder system.
> Referenced from CLAUDE.md via `@docs/visual-builder/architecture.md`.

## Key Components and Their Responsibilities

### Main Entry Point
- **[VisualBuilder.tsx](src/visual-builder/VisualBuilder.tsx)**: Root component that orchestrates all functionality
...
### Layout Components
- **[CanvasLayout.tsx](src/visual-builder/CanvasLayout.tsx)**: Main layout orchestrator
...
- **[CanvasArea.tsx](src/visual-builder/CanvasArea.tsx)**: ReactFlow canvas wrapper
...
### Sidebar Panels
- **[BuilderSidebar.tsx](src/visual-builder/panels/BuilderSidebar.tsx)**: Left sidebar with tab navigation
...
- **[NodeLibrary.tsx](src/visual-builder/panels/NodeLibrary.tsx)**: Node palette with drag-and-drop
...
- **[FunctionsPanel.tsx](src/visual-builder/panels/FunctionsPanel.tsx)**: Function management
  - Create/delete/open custom functions
  - Shows function I/O port counts
  - Active function highlighting
  - Delete confirmation dialog

- **[VariablesPanel.tsx](src/visual-builder/panels/VariablesPanel.tsx)**: Variable inspection and navigation

### Configuration Panels
- **[NodeConfigPanel.tsx](src/visual-builder/panels/NodeConfigPanel.tsx)**: Right panel for node configuration
...
- **[FunctionDefinitionPanel.tsx](src/visual-builder/panels/FunctionDefinitionPanel.tsx)**: Right panel for function canvases
  - Define function inputs/outputs
  - Add/remove/edit ports with name and dataType
  - Only visible when on a function canvas

### Node Visualization
- **[CustomNode.tsx](src/visual-builder/graph/CustomNode.tsx)**: Visual node component
...
- **[CustomEdge.tsx](src/visual-builder/graph/CustomEdge.tsx)**: Custom edge rendering
- **[PortHandle.tsx](src/visual-builder/graph/PortHandle.tsx)**: Connection port visualization

### Input Components
- **[ParameterEditor.tsx](src/visual-builder/inputs/ParameterEditor.tsx)**: Multi-type parameter editor
- **[ExpressionInput.tsx](src/visual-builder/inputs/ExpressionInput.tsx)**: Expression editor with variable references

### Dialogs
- **[ImportExportDialogs.tsx](src/visual-builder/dialogs/ImportExportDialogs.tsx)**: JSON import/export, save dialog
- **[AgentTestDialog.tsx](src/visual-builder/dialogs/AgentTestDialog.tsx)**: Testing interface for agent nodes
...
### [canvasStore.ts](src/visual-builder/store/canvasStore.ts) - Multi-Instance Canvas State
...
### [history.ts](src/visual-builder/utils/history.ts) - Undo/Redo Middleware
...
### [diagnosticsStore.ts](src/visual-builder/store/diagnosticsStore.ts) - Flat Diagnostics State
...
### Canvas Management
**[useGraph(canvasId)](src/visual-builder/hooks/useGraph.ts)** - Node CRUD and history
