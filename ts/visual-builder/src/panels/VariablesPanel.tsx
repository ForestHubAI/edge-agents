    ...
    return (
      <div className="flex flex-col items-center justify-center py-8 text-center">
        ...
        <p className="text-xs text-muted-foreground/70 mt-1">
          {t("builder.addNodesForVariables")}
        </p>
        {!readOnly && (
  ...
  return (
    <div className="space-y-5">
      ...
      {!isMainCanvas && functionArgs.length > 0 && (
        <div>
          <SectionHeader title={t("builder.functionArguments")} />
      ...
      {nodeOutputs.length > 0 && (
        <div>
          <SectionHeader title={t("builder.nodeOutputVariables")} />
      ...
      {/* Defined Variables */}
      <div>
        <SectionHeader title={t("builder.definedVariables")} />
