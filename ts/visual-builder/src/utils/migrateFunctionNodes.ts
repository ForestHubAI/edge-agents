import type { Expression, FunctionInfo, OutputBinding } from "@foresthub/workflow-core/types/node";
import type { FunctionCallNode } from "@foresthub/workflow-core/types/node/FunctionNode";
...
export function migrateFunctionCallNodes(): void {
  ...
  if (totalMigrated > 0) {
    toast({
      title: i18n.t("builder.functionCallNodesMigrated"),
      description: i18n.t("builder.functionCallNodesMigratedDesc", { count: totalMigrated }),
    });
  }
}
