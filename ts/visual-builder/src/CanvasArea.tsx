...
import { NodeCategory, NodeDefinition, NodeInstance } from "@foresthub/workflow-core/types/node";
import { getOrCreateCanvasStore } from "./store/canvasStore";
import { useEditorStore, isReadOnly } from "./store/editorStore";
import { isValidConnection as validateConnection } from "./utils/portUtils";
...
const CanvasArea = (props: CanvasAreaProps) => {
  return (
